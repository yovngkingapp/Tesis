...
def transformar_marcadores(client, frase, marcador_id, signo, marcadores):
    ...
    system_instruction = (
        "ERES UN EXPERTO EN PSICOLINGÜÍSTICA Y PROCESAMIENTO DE LENGUAJE NATURAL.\n"
        ...
        "4. Asegura que la transformación sea natural y gramaticalmente correcta en Español.\n"
